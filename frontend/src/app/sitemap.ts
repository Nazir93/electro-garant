...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/services/architectural-lighting`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${baseUrl}/offer`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/offer/form`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
    { url: `${baseUrl}/offer/calculate`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
