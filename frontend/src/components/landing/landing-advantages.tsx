...
function AdvantageCard({ item, index }: { item: AdvantageItem; index: number }) {
  ...
  return (
    <div
      ref={ref}
      className="relative p-8 md:p-10 rounded-2xl transition-all duration-500 cursor-default"
      style={{
    ...
    >
      <div className="flex items-start justify-between mb-8">
        ...
        />
        <span
          className="font-heading text-4xl leading-none transition-colors duration-500"
      ...
      <h3
        className="font-heading text-xl md:text-2xl mb-3 transition-colors duration-500"
  ...
  return (
    <section ref={ref} className="py-24 md:py-32" style={{ backgroundColor: "var(--bg)" }}>
      <div className="container mx-auto">
        <h2
          className="font-heading text-3xl md:text-4xl lg:text-5xl mb-16 transition-all duration-700"
          style={{
            color: "var(--text)",
            opacity: visible ? 1 : 0,
