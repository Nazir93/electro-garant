...
export function getServicesIndexSeo(): ServicesIndexSeoBundle {
  return {
    ...
    description: `Проектирование и монтаж электрики, умного дома, СКС, видеонаблюдения и акустики для бизнеса и частных объектов.${GEO_TAIL} СРО, гарантия 2 года.`,
    keywords: [
      `электромонтаж ${C}`,
  ...
  switch (slug) {
    case "electrical":
      return {
        ...
        description: `Электромонтаж квартир, ресторанов и офисов в ${C}: проектирование, щиты ABB и Schneider, силовые линии, освещение, пусконаладка. Допуск СРО, гарантия 2 года.${GEO_TAIL}`,
        keywords: [
          `электромонтаж ${C}`,
    ...
    case "acoustics":
      return {
        ...
        description: `Проектирование и монтаж мультизонального звука для ресторанов, кафе и ритейла в ${C}. Фон, зоны, Bose и JBL. Гарантия 2 года.${GEO_TAIL}`,
        keywords: [
    ...
    case "structured-cabling":
      return {
        ...
        description: `Монтаж структурированных кабельных сетей и слаботочки в ${C}: серверная, Cat 6A, телефония, ЛВС. Проект, сдача и гарантия 2 года.${GEO_TAIL}`,
        keywords: [
          `СКС ${C}`,
    ...
    case "smart-home":
      return {
        ...
        description: `Монтаж умного дома в ${C}: автоматизация света, климата и мультимедиа, KNX и Z-Wave, сценарии и интеграции. Проект, пусконаладка, гарантия 2 года.${GEO_TAIL}`,
        keywords: [
          `умный дом ${C}`,
    ...
    case "security":
      return {
        ...
        description: `Монтаж IP-видеонаблюдения и контроля доступа в ${C}: камеры, архив, СКУД для офиса и дома. Проект, монтаж, настройка приложений. Гарантия 2 года.${GEO_TAIL}`,
        keywords: [
          `видеонаблюдение ${C}`,
          `установка камер ${C}`,
